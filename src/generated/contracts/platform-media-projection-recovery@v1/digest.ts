...
import {
  RefreshMediaProjectionRecoveryAccessEffectSchema,
  type RefreshMediaProjectionRecoveryAccessEffect,
} from "../../proto/kokoro/platform/media/v1/media_projection_recovery_pb.js";
...
export function mediaProjectionRecoveryRefreshRequestDigest(
  ...
  return commandEnvelopeV2Digest({
    ...
    targetRefs: [effect.bindingRef, effect.operationRef],
    effect: {
      typeName: RefreshMediaProjectionRecoveryAccessEffectSchema.typeName,
      bytes: toBinary(RefreshMediaProjectionRecoveryAccessEffectSchema, effect, { writeUnknownFields: false }),
    },
  });
}
