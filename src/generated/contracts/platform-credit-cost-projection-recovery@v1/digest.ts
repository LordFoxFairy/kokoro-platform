...
import {
  RefreshCreditCostProjectionRecoveryAccessEffectSchema,
  type RefreshCreditCostProjectionRecoveryAccessEffect,
} from "../../proto/kokoro/platform/credit/v1/cost_projection_recovery_pb.js";
...
export function creditCostProjectionRecoveryRefreshRequestDigest(
  ...
  return commandEnvelopeV2Digest({
    ...
    targetRefs: [effect.bindingRef, effect.costProjectionRef],
    effect: {
      typeName: RefreshCreditCostProjectionRecoveryAccessEffectSchema.typeName,
      bytes: toBinary(RefreshCreditCostProjectionRecoveryAccessEffectSchema, effect, { writeUnknownFields: false }),
    },
  });
}
