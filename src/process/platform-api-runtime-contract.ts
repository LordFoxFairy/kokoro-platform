export const PLATFORM_API_RUNTIME_CONTRACT = Object.freeze({
  ...
  files: Object.freeze([
    ...
    file("PLATFORM_ARTIFACT_DELIVERY_CAPABILITY_KEY_FILE", "artifact-delivery-capability-key.json", true,
      "artifact-delivery-capability-hmac-key"),
    file("PLATFORM_ARTIFACT_OWNER_CURSOR_KEY_FILE", "artifact-owner-cursor-key.json", true,
      "artifact-owner-cursor-hmac-key"),
