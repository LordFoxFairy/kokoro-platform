...
function receipt(): StoredRedemptionReceipt {
  return {
    ...
    outputs: [{ kind: "credit_grant", outputLineId: "credits", outputOrdinal: 1, occurrence: 1,
      resourceRef: "00000000-0000-7000-8000-000000000303", templateRevisionRef: "credit-v1",
      outputVersion: 1, outputDigest: "b".repeat(64) }],
