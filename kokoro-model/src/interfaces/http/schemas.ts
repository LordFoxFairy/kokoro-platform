...
export const ensureProviderAccountRequestSchema = z.object({
...
export const ensureModelBindingRequestSchema = z.object({
...
export const listModelBindingsQuerySchema = z.object({
